...
if (isset($_POST['studsu'])) {
    ...
    if ($password1 == $cpassword1) {
      $s1 = "select * from student where usn='{$usn1}'";
      $s = mysqli_query($conn, $s1);
      if (mysqli_num_rows($s) == 0) {
        ...
        echo "<script>
                alert('Data enter by you alreay exist in Database please log In');
                window.location.replace(\"index.php\");</script>";
          session_destroy();
      }
    }
...
require 'sql.php';
        ...
        if ($password2 == $cpassword2) {
          $s1 = "select * from staff where staffid='{$usn2}'";
          $s = mysqli_query($conn, $s1);
          if (mysqli_num_rows($s) == 0) {
        ...
        <div class="modal-content">
          ...
          <div class="modal-body bg-gradient-danger">
            ...
            >
			   ...
			   <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input
                    ...
                    pattern="[a-z A-Z 0-9]+@[A-Z a-z]+\.com"
                    id="email"
                    name="mail2"
                    type="email"
                    class="validate"
              ...
              <div class="form-group row">
  <label class="col-md-2 col-form-label text-white" for="dob2">Date Of Joining</label>
  <div class="col-md-10">
    <input
      autocomplete="new-password"
      class="white-text validate form-control"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body bg-gradient-primary">
            ...
            >
              ...
              <div class="form-group row">
  <label class="col-md-2 col-form-label text-white" for="dob1">DOB</label>
  <div class="col-md-10">
    <input
      autocomplete="new-password"
      class="white-text validate form-control"
